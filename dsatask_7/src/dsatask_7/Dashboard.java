...
private void displayUserId(String username) {
        // Assuming you have a method to retrieve the user's ID from the database
        String userId = getUserIdFromDatabase(username);

        // Display the user's ID in the name JLabel
        name.setText("Welcome, " + username + "! (ID: " + userId + ")");
    }
    /**
